...
class ArtistManagerRemoveCommand extends Command
{
    /**
     * @var EntityManager
     */
    ...
    {
        $this
            ->setName('app:artist:remove')
            ->setDescription('Remove artist')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln($this->entityManager->getRepository("AppBundle\Command\Artist")->find($id));
